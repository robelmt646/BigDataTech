...
public class SparkSQLKafkaStream {
	public static void main(String[] args) throws StreamingQueryException {
	    ...
	    .option("path", "hdfs://localhost:2181/home/cloudera/twitterImport")
	    .option("checkpointLocation", "hdfs://localhost:2181/home/cloudera/twitterCheckpoint") 
	    .start()
	    .awaitTermination();
